...
-   Repeat the simulation above for A = 1 and A = 1.5. Show all three ROCs on the same plot with clear legends and labels. Keep all other parameters fixed: ($\mu_w = 0$, $\sigma_w^2 = 1$, $k = 10$).

-   Repeat the simulation above for k = 15, k = 20, k= 30. Show all three ROCs on the same plot with clear legends and labels. Keep all other parameters fixed: ($\mu_w = 0$, $\sigma_w^2 = 1$, $A = 0.5$).
